...
(function(){
  ...
  var EXAMPLES = {
    ...
    string:{
      ...
      steps:[
        {node:'start', line:null, cap:'প্রোগ্রাম শুরু হলো।'},
        {node:'n1', line:0, cap:'নাম১ এ "আনিছুর" রাখা হলো।'},
        {node:'n2', line:1, cap:'নাম২ এ "রহমান" রাখা হলো।'},
        {node:'n3', line:2, cap:'দুটি স্ট্রিং যুক্ত করা হলো: "আনিছুর রহমান"।'},
        {node:'n4', line:3, cap:'ফলাফল দেখানো হলো: আনিছুর রহমান।'},
        {node:'end', line:null, cap:'প্রোগ্রাম শেষ।'}
      ]
    }
  };
